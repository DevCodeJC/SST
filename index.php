...
$query2 = "SELECT id_cat, nom_cat FROM Categorias";
...
<h3>Actos & Condiciones inseguras</h3>
	<input type="number" min="1" max= "9999999999" placeholder="Cedula" name="cedula" required><br/>
